...
function aplicarDesconto(valor, desconto) {
    percentualDeDesconto = (desconto / 100) * valor
    return (valor - percentualDeDesconto);
}

function aplicarAcrescimo(valor, acrescimo) {
    percentualDeAcrescimo = (acrescimo / 100) * valor
    return (valor + percentualDeAcrescimo);
}

const valorEtiqueta = 200;
...
if (condicaoDePagamento === 1) {
    ...
    console.log (aplicarAcrescimo(valorEtiqueta, 10));
}
